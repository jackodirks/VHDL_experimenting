...
/*  09/09/2013(MichaelA): added definition of dprpJtgSetGetGpio         */
/*  09/09/2013(MichaelA): added DjtgGetGpioMask, DjtgSetGpioDir,        */
/*      DjtgGetGpioDir, DjtgSetGpioState, and DjtgGetGpioState          */
/*  09/11/2013(MichaelA): added definition of jcbGetGpioMask,           */
/*      jcbSetGpioDir, jcbGetGpioDir, jcbSetGpioState, and              */
/*      jcbGetGpioState batch commands and djbpSetGetGpio               */
/*                                                                      */
/************************************************************************/
...
const DPRP  dprpJtgSetGetGpio       = 0x00080000; // port supports DjtgSetGpioState and related functions
...
#define jcbGetGpioMask      11
#define jcbSetGpioDir       12
#define jcbGetGpioDir       13
#define jcbSetGpioState     14
#define jcbGetGpioState     15

const UINT32    djbpWaitUs      = 0x00000001;
const UINT32    djbpSetAuxReset = 0x00000002;
const UINT32    djbpSetGetGpio  = 0x00000004;
...
// gpio functions
DPCAPI BOOL DjtgGetGpioMask(HIF hif, DWORD * pfsMaskOut, DWORD * pfsMaskIn);
DPCAPI BOOL DjtgSetGpioDir(HIF hif, DWORD fsDirReq, DWORD * pfsDirSet);
DPCAPI BOOL DjtgGetGpioDir(HIF hif, DWORD * pfsDir);
DPCAPI BOOL DjtgSetGpioState(HIF hif, DWORD fsState);
DPCAPI BOOL DjtgGetGpioState(HIF hif, DWORD * pfsState);
